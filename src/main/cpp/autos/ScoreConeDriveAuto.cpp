...
ScoreConeDriveAuto::ScoreConeDriveAuto(std::shared_ptr<SwerveDrive> swerve, std::shared_ptr<Arm> arm, std::shared_ptr<Intake> intake) {
    SetName("high cone drive");
    ...
    AddCommands(
        ...
        frc2::WaitCommand(units::second_t(1.5)), // wait a second
