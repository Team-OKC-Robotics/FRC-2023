// #include "autos/KickTheCubeAutp.h"
...
// KickTheCubeAutp::KickTheCubeAuto(std::shared_ptr<SwerveDrive> swerve, std::shared_ptr<Arm> arm, std::shared_ptr<Intake> intake) {
//     SetName("kick the cube");
